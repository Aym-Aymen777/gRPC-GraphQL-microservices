...
const (
	CatalogService_AddProduct_FullMethodName        = "/catalog.CatalogService/AddProduct"
	...
	CatalogService_RemoveProduct_FullMethodName     = "/catalog.CatalogService/RemoveProduct"
	CatalogService_ListProducts_FullMethodName      = "/catalog.CatalogService/ListProducts"
	CatalogService_SearchForProducts_FullMethodName = "/catalog.CatalogService/SearchForProducts"
)
...
type CatalogServiceClient interface {
	...
	SearchForProducts(ctx context.Context, in *SearchForProductsRequest, opts ...grpc.CallOption) (*SearchForProductsResponse, error)
}
...
func (c *catalogServiceClient) GetProductDetails(ctx context.Context, in *GetProductDetailsRequest, opts ...grpc.CallOption) (*GetProductDetailsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *catalogServiceClient) RemoveProduct(ctx context.Context, in *RemoveProductRequest, opts ...grpc.CallOption) (*RemoveProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveProductResponse)
	err := c.cc.Invoke(ctx, CatalogService_RemoveProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogServiceClient) SearchForProducts(ctx context.Context, in *SearchForProductsRequest, opts ...grpc.CallOption) (*SearchForProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchForProductsResponse)
	err := c.cc.Invoke(ctx, CatalogService_SearchForProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CatalogServiceServer interface {
	...
	SearchForProducts(context.Context, *SearchForProductsRequest) (*SearchForProductsResponse, error)
...
func (UnimplementedCatalogServiceServer) GetProductDetails(context.Context, *GetProductDetailsRequest) (*GetProductDetailsResponse, error) {
...
func (UnimplementedCatalogServiceServer) RemoveProduct(context.Context, *RemoveProductRequest) (*RemoveProductResponse, error) {
...
func (UnimplementedCatalogServiceServer) SearchForProducts(context.Context, *SearchForProductsRequest) (*SearchForProductsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchForProducts not implemented")
}
...
func _CatalogService_RemoveProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveProductRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServiceServer).RemoveProduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_RemoveProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).RemoveProduct(ctx, req.(*RemoveProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CatalogService_SearchForProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchForProductsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServiceServer).SearchForProducts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_SearchForProducts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).SearchForProducts(ctx, req.(*SearchForProductsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CatalogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CatalogService_RemoveProduct_Handler,
		},
		{
		...
		{
			MethodName: "SearchForProducts",
			Handler:    _CatalogService_SearchForProducts_Handler,
		},
	},
